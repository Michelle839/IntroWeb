...
function agregarFila(tabla, id, nombre) {
  ...
  var btnEditar = cellAcciones.querySelector(".btn-editar");
  var btnEliminar = cellAcciones.querySelector(".btn-eliminar");
...
function editarFila(row) {
  var cellNombre = row.cells[1];
  var nuevoNombre = prompt("Ingrese el nuevo nombre:", cellNombre.textContent);
  if (nuevoNombre) {
    cellNombre.textContent = nuevoNombre;
  }
}
